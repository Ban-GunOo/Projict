    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                      <div style="border: 1px solid gold; float: left; width: 100%;">
                        <img src="경로" width="265" height="400" > <!-- 사진 -->
                        </div>
                    </div>
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                            ...
                            <div class="anime__details__widget">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            <li><span>장르:</span> ㅁㅁ</li>
                                            <li><span>감독:</span> ㅁㅁ</li>
                                            <li><span>개봉일:</span> ㅁ년ㅁ월ㅁ일</li>
                                            <li><span>출연:</span> ㅁㅁ,ㅁㅁ</li>
                                            <li><span>상영등급:</span> ㅁㅁ</li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            <li><span>평점:</span> 7.31 / 1,515</li>
                                            <li><span>제작비:</span> 8.5 / 161 times</li>
                                            <li><span>상영시간:</span> ㅁㅁ분</li>
                                            <li><span>관객 수:</span> 131,541</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="anime__details__btn">
                                ...
                                <a href="#" class="watch-btn"><span>지금 보기</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <div class="anime__details__review">
                        ...
                        <div class="anime__review__item"> <!-- 리뷰 한 칸-->
                            <div class="anime__review__item__pic"> 
                    ...
                    <div class="anime__details__form">
                        ...
                        <form action="#">
                            ...
                            <button type="submit"><i class="fa fa-location-arrow"></i>작성</button>
                        </form>
                    </div>
                </div>
